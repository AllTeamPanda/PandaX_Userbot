...
"""
        ...
        bttn = [
            ...
            [
                InlineKeyboardButton(
                    text="🏧 Data Petercord_Userbot 🏧", callback_data=f"make_ilham_bot"
                )
            ],
            [
             InlineKeyboardButton(
        ...
        nice_text = f"**🏅 Petercord_UserBot Commands** \n**🤖 Petercord Version :** __{Petercord_version}__ \n**✡ PyroGram Version :** __{__version__}__ \n**🏧 Total Plugins Loaded :** __{total_}__"
...
async def cmd_buutton(client, cb):
    ...
    await cb.edit_message_text("🎗 Data Petercord_Userbot 🎗", reply_markup=InlineKeyboardMarkup(bttn))
...
@cb_wrapper
async def close_it_please(client, cb):
    await cb.edit_message_text("**🚫 Menu Terhapus Semua 🚫**!")
