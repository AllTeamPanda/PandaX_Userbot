...
from Pandabot.core.bot_users import add_user, check_user, get_all_users
from Pandabot import bot, start_time
from Pandabot.config import Config
from Pandabot.utils.assistant_helpers import (
    _check_admin,
    _check_owner_or_sudos,
)
from Pandabot.utils.basic_helpers import get_all_pros, get_readable_time
    ...
    if user_id not in all_user_s:
        await client.send_photo(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("Help Me ❓", url="t.me/PandaUserbotSupport")]]
            ),
        )
