...
from PandaX_Userbot import LOGSPAMMER, Stark as telethn
import sys
...
from PandaX_Userbot import CMD_HELP, MONGO_DB_URI
import inspect
import re
import logging
import glob
...
def pandabotx(**args):
    ...
    def decorator(func):
        ...
        Stark.add_event_handler(wrapper, events.NewMessage(**args))
        return wrapper
...
def Xpanda(**args):
    ...
    def decorator(func):
        ...
        if not disable_edited:
            Stark.add_event_handler(wrapper, events.MessageEdited(**args))
        Stark.add_event_handler(wrapper, events.NewMessage(**args))
        return wrapper
    return decorator
