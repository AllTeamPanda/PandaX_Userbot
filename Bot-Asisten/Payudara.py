...
@Stark.on(events.callbackquery.CallbackQuery(data="payudara"))
async def _(event):
    await event.edit(Payudara, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbot")]])

@Stark.on(events.callbackquery.CallbackQuery(data="payudaras"))
async def _(event):
    await event.edit(Payudara, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbott")]])
