...
async def _(event):
    ...
    await event.edit(LOCKS_HELP, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbot")]])


@Stark.on(events.callbackquery.CallbackQuery(data="lockss"))
async def _(event):

    await event.edit(LOCKS_HELP, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbott")]])
