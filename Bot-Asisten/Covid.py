...
async def _(event):
    await event.edit(Covid, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbot")]])

@Stark.on(events.callbackquery.CallbackQuery(data="covids"))
async def _(event):
    await event.edit(Covid, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbott")]])
...
async def _(event):
    await event.edit(Telegraph, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbot")]])

@Stark.on(events.callbackquery.CallbackQuery(data="telegrams"))
async def _(event):
    await event.edit(Telegraph, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbott")]])
...
async def _(event):
    await event.edit(TINY, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbot")]])

@Stark.on(events.callbackquery.CallbackQuery(data="tinys"))
async def _(event):
    await event.edit(TINY, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbott")]])
