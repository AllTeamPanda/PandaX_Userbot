...
async def _(event):
    ...
    await event.edit(ADMIN_TEXT, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbot")]])


@Stark.on(events.callbackquery.CallbackQuery(data="admins"))
async def _(event):

    await event.edit(ADMIN_TEXT, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbott")]])
