...
async def _(event):
    ...
    await event.edit(PINS_TEXT, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbot")]])

@Stark.on(events.callbackquery.CallbackQuery(data="pinss"))
async def _(event):

    await event.edit(PINS_TEXT, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbott")]])
