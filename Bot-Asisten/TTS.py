from PandaX_Userbot import Stark as tbot
import os
...
- /tts lang | text`\nFor eg: `/tts en | hello
"""
@tbot.on(events.callbackquery.CallbackQuery(data="tts"))
async def _(event):
    await event.edit(Tts, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbot")]])

@tbot.on(events.callbackquery.CallbackQuery(data="ttss"))
async def _(event):
    await event.edit(Tts, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbott")]])
