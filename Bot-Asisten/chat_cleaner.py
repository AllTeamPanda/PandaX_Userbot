...
async def _(event):
    await event.edit(CLEANER_HELP, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbot")]])

@Stark.on(events.callbackquery.CallbackQuery(data="zombiess"))
async def _(event):
    await event.edit(CLEANER_HELP, buttons=[[Button.inline("« Bᴀᴄᴋ", data="helpbott")]])
