...
from PandaX_Userbot import StartTime
import time
import datetime
...
ALIVEPANDA = """
Hᴇʟʟᴏ Tʜɪs ɪs Asisten

Aʟʟ sʏsᴛᴇᴍs ᴡᴏʀᴋɪɴɢ

Aisten Vᴇʀsɪᴏɴ : 1.0.1
...
async def repo(event):
  await Stark.send_message(event.chat, "**PandaX_Userbot** \n\nDepolover :- @diemmmmmmmmmm", buttons=[[Button.url(" Rᴇᴘᴏ ", "https://github.com/ilhammansiz/PandaX_Userbot"), Button.url(" Dᴇᴘʟᴏʏ ", "https://heroku.com/deploy?template=https://github.com/ilhammansiz/PandaX_Userbott-Deploy")]])
