...
@pandaub.ilhammansiz_cmd(
    ...
    info={
        ...
        "examples": [
            "{tr}lyrics Mungkin nanti",
            "{tr}lyrics Noah - Yang terdalam",
        ],
    },
)
async def _(event):
    "Song lyrics searcher"
    pandaevent = await edit_or_reply(event, "`wi8..! I am searching your lyrics....`")
    ...
    if event.pattern_match.group(1):
        ...
        return await pandaevent.edit("`What I am Supposed to find `")
    song = ""
...
async def lyrics(lyric):
    ...
    try:
        ...
        songs = None
    if songs is None:
        return await pandaevent.edit(f"Song **{artist} - {song}** not found!")
