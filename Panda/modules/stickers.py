...
from .. import S_PACK_NAME as custompack
from .. import tgbot
from ..modules.sql_helper.globals import addgvar, gvarstatus
from ..misc import edit_delete, edit_or_reply, pandacute
from ..misc.misc import animator
...
@pandacute(pattern="stickers ?([\s\S]*)")
