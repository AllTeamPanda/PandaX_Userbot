...
@bot.on(Cutepanda(outgoing=True, pattern=r"reserved$"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"name"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"setpfp$"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"setbio (.*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"username (.*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"count$"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"delpfp"))
...
@bot.on(Cutepanda(pattern=r"info(?: |$)(.*)", outgoing=True))
async def who(event):
