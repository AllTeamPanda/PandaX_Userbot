...
from .. import CMD_HELP, TEMP_DOWNLOAD_DIRECTORY, ZIP_DOWNLOAD_DIRECTORY, bot
...
@bot.on(Cutepanda(outgoing=True, pattern=r"compress(?: |$)(.*)"))
async def _(event):
...
@bot.on(Cutepanda(outgoing=True, pattern=r"addzip(?: |$)(.*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"upzip(?: |$)(.*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"rmzip(?: |$)(.*)"))
