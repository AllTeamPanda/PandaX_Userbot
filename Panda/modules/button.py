...
from .. import CMD_HELP, tgbot
from ..misc import edit_delete, pandacute, reply_id
...
@pandacute(pattern="cbutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
@pandacute(pattern="ibutton(?:\\s|$)([\\s\\S]*)")
async def _(event):
...
CMD_HELP.update(
    {
        ...
        \n  •  **Examples : **`{cmd}cbutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/PandaUserbot:same> [Support]<buttonurl:https://t.me/TeamSquadUserbotSuport>`\
        ...
        \n  •  **Examples : **`{cmd}ibutton test [google]<buttonurl:https://www.google.com> [Channel]<buttonurl:https://t.me/PandaUserbot:same> [Support]<buttonurl:https://t.me/TeamSquadUserbotSuport>`\
    "
    }
)
