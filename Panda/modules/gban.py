...
from .. import DEVS, bot, owner
from ..events import Cutepanda, register
from ..misc import get_user_from_event
...
@bot.on(Cutepanda(outgoing=True, pattern=r"gband(?: |$)(.*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"ungband(?: |$)(.*)"))
