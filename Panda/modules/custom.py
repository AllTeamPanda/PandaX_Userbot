...
from ..modules.sql_helper import snips_sql as sql
from ..misc import edit_delete, edit_or_reply, pandacute, reply_id


@pandacute(pattern=r"\#(\S+)")
...
@pandacute(pattern="custom(?:\\s|$)([\\s\\S]*)")
...
@pandacute(pattern="delcustom(?:\\s|$)([\\s\\S]*)")
async def _(event):
