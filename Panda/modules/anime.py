...
@bot.on(Cutepanda(outgoing=True, pattern=r"anilist ?(.*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"anime ?(.*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"manga ?(.*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern="a(kaizoku|kayo) ?(.*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"char ?(.*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern="upcoming$"))
...
@bot.on(Cutepanda(outgoing=True, pattern="whatanime$"))
