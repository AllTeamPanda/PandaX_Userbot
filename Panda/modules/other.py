...
from .. import CMD_HELP, BYPASS_URL, owner
from ..misc import edit_delete, edit_or_reply, pandacute


@pandacute(pattern="open(?: |$)(.*)")
async def _(event):
