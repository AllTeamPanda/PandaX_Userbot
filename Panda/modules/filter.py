...
@bot.on(Cutepanda(outgoing=True, pattern="filter (.*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern="filters$"))
...
@bot.on(Cutepanda(outgoing=True, pattern="stop ([\s\S]*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern="rmallfilters$"))
