...
from ..misc import bash, chrome, edit_or_reply, pandacute, progress
...
@pandacute(pattern="deez (.+?|) (FLAC|MP3\_320|MP3\_256|MP3\_128)")
async def _(event):
