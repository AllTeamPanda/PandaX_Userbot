...
from .. import bot, vcbot as call_py
from .. import CMD_HELP, CMD_HANDLER as cmd
...
from ..misc.chattitle import CHAT_TITLE
from ..misc.queues.queues import (
    QUEUE,
    add_to_queue,
    clear_queue,
    get_queue,
...
from ..misc.thumbnail import gen_thumb
...
CMD_HELP.update(
    {
        ...
        \n\n ➕   **Syntax :** `{cmd}joinvc` & `{cmd}leavevc`\
        \n\n ➕ **Function :** Untuk Join dan leveave Vc Grup\
        \n\n  ➕  **Syntax :** `{cmd}play` <Judul Lagu/Link YT>\
        \n  ➕  **Function : **Untuk Memutar Lagu di voice chat group dengan akun kamu\
        \n\n  ➕  **Syntax :** `{cmd}videoplay` <Judul Video/Link YT>\
