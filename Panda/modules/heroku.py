...
from .. import CMD_HELP, HEROKU_API_KEY, HEROKU_APP_NAME, SUDO_USERS
from ..modules.sql_helper.globals import addgvar, delgvar, gvarstatus
...
@pandacute(pattern="(get|del) var(?: |$)(\w*)")
...
@pandacute(pattern="set var (\w*) ([\s\S]*)")
