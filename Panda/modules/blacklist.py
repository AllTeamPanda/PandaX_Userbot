...
@bot.on(Cutepanda(outgoing=True, pattern=r"addbl(?: |$)(.*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"listbl(?: |$)(.*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"rmbl(?: |$)(.*)"))
