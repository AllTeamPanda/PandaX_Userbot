...
from ..modules.sql_helper.bot_starters import (
    add_starter_to_db,
    get_all_starters,
    get_starter_details,
)
from ..modules.sql_helper.globals import gvarstatus
from ..misc import _format, asst_cmd, callback, reply_id
    ...
    if chat.id != OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**👋 Hai** {mention}**!**\
                        ...
                        \n\n**Powered** by [PandaUserBot](https://github.com/ilhammansiz/PandaX_Userbot)"
        buttons = [
            (
