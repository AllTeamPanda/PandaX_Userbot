...
from .. import CMD_HELP, LOGS, TEMP_DOWNLOAD_DIRECTORY, bot
from ..events import Cutepanda
from ..misc import humanbytes, progress, run_cmd
from ..misc.FastTelethon import download_file, upload_file


@bot.on(Cutepanda(pattern=r"download(?: |$)(.*)", outgoing=True))
...
@bot.on(Cutepanda(pattern=r"upload (.*)", outgoing=True))
