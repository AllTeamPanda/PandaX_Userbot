...
from ..modules.upload_download import get_video_thumb
from ..misc import (
    chrome,
    edit_delete,
    edit_or_reply,
...
from ..misc.FastTelethon import upload_file
...
@bot.on(Cutepanda(outgoing=True, pattern=r"img (.*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"currency ([\d\.]+) ([a-zA-Z]+) ([a-zA-Z]+)"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"google ([\s\S]*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"wiki (.*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"ud (.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(Cutepanda(outgoing=True, pattern=r"tts(?: |$)([\s\S]*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"tr(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
...
@bot.on(Cutepanda(pattern=r"lang (tr|tts) (.*)", outgoing=True))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"utube (\d*) *(.*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"yt(audio|video( \d{0,4})?) (.*)"))
...
@bot.on(Cutepanda(outgoing=True, pattern=r"rbg(?: |$)(.*)"))
async def kbg(remob):
...
@bot.on(Cutepanda(pattern=r"ocr (.*)", outgoing=True))
async def ocr(event):
...
@bot.on(Cutepanda(pattern=r"decode$", outgoing=True))
...
@bot.on(Cutepanda(pattern=r"barcode(?: |$)([\s\S]*)", outgoing=True))
async def bq(event):
...
@bot.on(Cutepanda(pattern=r"makeqr(?: |$)([\s\S]*)", outgoing=True))
...
@bot.on(Cutepanda(pattern=r"ss (.*)", outgoing=True))
