...
from .. import CMD_HELP, GIT_REPO_NAME, GITHUB_ACCESS_TOKEN, bot
from ..misc import pandacute

GIT_TEMP_DIR = "./Panda/temp/"


@pandacute(pattern="gcommit(?: |$)(.*)")
...
async def git_commit(file_name, mone):
    ...
    file_name = "Panda/modules/" + file_name
    if create_file:
        ...
        try:
            ...
            ccess = ccess.strip()
            await mone.edit(
                f"`Commited On Your Github Repo`\n\n[Your Modules](https://github.com/{ccess}/tree/sql-extended/Panda/modules/)"
            )
