...
from .. import DEVS, TEMP_DOWNLOAD_DIRECTORY
from ..misc import runcmd
...
async def animator(media, mainevent, textevent):
    ...
    panda = await mainevent.client.download_media(media, TEMP_DOWNLOAD_DIRECTORY)
