...
@PandaBot.register(
    ...
    help={
        ...
        "examples": [
            "{tr}gs PandaUserbot",
            "{tr}gs -l6 PandaUserbot",
            "{tr}gs -p2 PandaUserbot",
            "{tr}gs -p2 -l7 PandaUserbot",
        ],
    },
)
async def gsearch(q_event):
    "Google search command."
    pandaevent = await edit_or_reply(q_event, "`searching........`")
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                return await edit_delete(pandaevent, f"**Error:**\n`{str(e)}`", time=10)
    msg = ""
    for i in range(lim):
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        pandaevent = await edit_or_reply(event, "Pre Processing Media")
        ...
        if previous_message.media:
            ...
            the_location = google_rs_response.headers.get("Location")
        await pandaevent.edit("Found Google Result. Pouring some soup on it!")
        headers = {
        ...
        try:
            ...
            return await edit_delete(
                pandaevent, "`Sorry. I am unable to find similar images`"
            )
        end = datetime.now()
...
async def _(img):
    ...
    if message and message.media:
        ...
        return
    if photo:
        pandaevent = await edit_or_reply(img, "`Processing...`")
        try:
            image = Image.open(photo)
        except OSError:
            return await pandaevent.edit("`Unsupported , most likely.`")
        name = "okgoogle.png"
        image.save(name, "PNG")
        image.close()
        ...
        if response != 400:
            ...
            return await pandaevent.edit("`Google told me to fuck off.`")
        os.remove(name)
        ...
        if guess and imgspage:
            ...
            return await pandaevent.edit("`Can't find any kind similar images.`")
