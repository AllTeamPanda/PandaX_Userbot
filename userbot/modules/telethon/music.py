...
@PandaBot.ilhammansiz_cmd(
    ...
    info={
        ...
        "examples": [
            "{tr}vplay",
            "{tr}vplay https://youtube.com/playlist?list=RDGVRbISIPfzk&playnext=1",
            "{tr}vplay -f https://youtube.com/playlist?list=RDGVRbISIPfzk&playnext=1",
        ],
    },
)
...
@PandaBot.ilhammansiz_cmd(
    ...
    info={
        ...
        "examples": [
            "{tr}play",
            "{tr}play https://youtube.com/playlist?list=RDGVRbISIPfzk&playnext=1",
            "{tr}play -f https://youtube.com/playlist?list=RDGVRbISIPfzk&playnext=1",
        ],
    },
)
