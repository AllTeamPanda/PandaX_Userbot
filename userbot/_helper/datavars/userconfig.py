...
USERDV = ["USER_NAME", "USER_USERNAME", "USER_ID", "USER_PIC", "USER_BIO"]
...
class UserConfig(object):
    ...
    def UserUsername(self):
        ...
        return (
            self.getdv("USER_USERNAME") or self.USER_USERNAME or self.username or None
        )

    def UserMention(self):
        """returns mention of user"""
        return (
            self.MentionMarkdown(self.UserId(), self.UserName())
