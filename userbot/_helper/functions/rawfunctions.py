...
class RawFunctions(object):
    ...
    async def error(self, message: Message, e, edit_error: bool = True):
        ...
        teks += f"`This can be a error in Panda Userbot, if you want you can forward this to @PandaUserbot.`\n\n"
    ...
    async def data(self, modules: str):
        ...
        try:
            ...
            for x, y in zip(
                ...
                module_data.append(f"**Examples**: `{self.PREFIX}{x}`\n**Description**: `{y}`\n\n")
            return module_data
        except Exception as e:
            self.log.error(e)
            return None
    ...
    def import_module(self, path: str, exclude: list = [], display_module: bool = True):
        ...
        ex:
                app.import_module("./userbot/module/spyrogram/", exclude=["admin"])
        """
